  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-30-1/2 -translate-x-1/2 w-150000px] bg-[#FF7F11]/10 blur-3xl rounded-full" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-500 text-lg">
            Seal Trust is a unified platform for generating digital certificates,
            attaching QR verification, and binding cryptographic identity.
          </p>
