...
export default function EditFeatureForm({
  ...
  const [form, setForm] = useState<IUpdateFeature>(formData ?? {});
  ...
  const handleChange = <K extends keyof IUpdateFeature>(
    field: K,
    value: IUpdateFeature[K]
  ) => {
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ...
          Contoh: <b>boolean</b> untuk ON/OFF fitur, <b>number</b> untuk limit
          seperti jumlah user.
        </p>
      </div>
