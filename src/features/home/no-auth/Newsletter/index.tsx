          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-500 mt-5 text-lg leading-relaxed">
                Get early access, request API integration, or talk to our team
                for enterprise deployment. We help you automate certificate
                issuance, QR verification, and representative binding.
              </p>

              {/* TRUST LINE */}
              <div className="mt-6 text-xs text-gray-400">
                Trusted for HR onboarding • Event certification • Enterprise
                verification
              </div>
