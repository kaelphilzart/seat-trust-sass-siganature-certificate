    ...
    const handleEditSubmit = async () => {
        ...
        await alert.confirmAsync(
            ...
            async () => {
                ...
                return { success: !!res, message: res ? 'User berhasil diperbarui!' : 'Gagal update user' };
            }
        );
...
//=====================================================================
    ...
    const columns = useMemo<ColumnDef<IUser>[]>(() => [
        ...
        {
            header: 'Status', accessorKey: 'is_active', cell: ({ getValue }) => getValue<boolean>() ?
    ...
    if (usersLoading) return <div className="p-4 text-center"><Loader /></div>;
    if (usersError) return <div className="p-4 text-center text-red-500"><ErrorFallback /></div>;
        ...
        <div>
            ...
            <div className="mb-4 flex items-center justify-between gap-3">
                <div className="w-full max-w-[320px]">
                    <InputSearch placeholder="email..." value={search}
            ...
            />
            <Modal open={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} onSubmit={handleAddSubmit} title="Tambah User">
                <AddUserForm formData={addFormData ?? undefined} onChange={data =>
                    setAddFormData(prev => JSON.stringify(prev) !== JSON.stringify(data) ? (data as ICreateUser) : prev
                    )} />
            </Modal>
            <Modal
