...
export default function EditPlanForm({ formData, onChange }: EditPlanFormProps) {
    const [form, setForm] = useState<IUpdatePlan>({
        ...formData,
    });
    ...
    const handleChange = <K extends keyof IUpdatePlan>(field: K, value: IUpdatePlan[K]) => {
