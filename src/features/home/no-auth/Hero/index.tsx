    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                ...
                {/* MAIN CENTER GLOW */}
                <div className="absolute -top-35 left-1/2 -translate-x-1/2 w-162.5 h-162.5 
    bg-[#FF7F11]/20 opacity-50 blur-3xl rounded-full animate-pulse" />

                {/* RIGHT BOTTOM GLOW */}
                <div className="absolute -bottom-35 -right-30 w-130 h-130 
    bg-orange-300/20 opacity-40 blur-3xl rounded-full animate-[pulse_6s_ease-in-out_infinite]" />

                {/* LEFT MID GLOW */}
                <div className="absolute top-[45%] -left-35 w-105 h-105 
    bg-amber-300/20 opacity-30 blur-3xl rounded-full animate-[pulse_8s_ease-in-out_infinite]" />
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                ...
                <p className="mt-5 text-gray-500 text-lg max-w-2xl mx-auto">
                    Seal Trust enables secure digital signatures, tamper-proof certificates,
                    and instant QR-based verification for modern organizations.
                </p>
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                    ...
                    <Link href="/#product">
                        <button className="px-6 py-3 rounded-lg bg-primary text-white font-medium transition hover:scale-105 active:scale-95 shadow-md animate-pulse">
                            Explore Product
                        </button>
                    </Link>
                ...
                <div className="mt-10 text-xs text-gray-400">
                    Trusted for HR onboarding, event certification, and enterprise verification
                </div>
