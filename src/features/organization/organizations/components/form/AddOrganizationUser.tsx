...
export default function AddOrganizationUserForm({
  organizationUserData,
  userData,
}: AddOrganizationUserFormProps) {
  const [form, setForm] = useState<Partial<ICreateOrganizationUser>>(
    organizationUserData ?? {}
  );
  const [formUser, setFormUser] = useState<Partial<ICreateUser>>(
    userData ?? {}
  );
  /* ===== SAVE DRAFT ===== */
