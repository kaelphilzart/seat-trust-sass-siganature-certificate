...
type Props = {
  onFinish: (isAddParticipant: boolean) => void;
};

export default function SevenStep({ onFinish }: Props) {
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      {/* HEADER */}
      <div className="flex items-center justify-between mb-4">
        <div className="text-sm text-black/45">
          Step 7 — Tambah Participant?
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded shadow space-y-4 text-center">
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <div className="text-lg font-medium">
            Apakah ingin menambahkan participant?
          </div>
        ...
        <div className="flex justify-center gap-4 mt-4">
          <Button variant="default" onClick={() => onFinish(true)}>
